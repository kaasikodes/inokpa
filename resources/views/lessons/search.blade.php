...
@include('inc.messages')
  <div class="container my-5 py-2">
      <!--heading -->
      <h1 class="title font-weight-bold" style="color: #024089">Lessons - Search Results</h1>
                   ...
                   <div class="col-md-12">
                       <div class="card mb-4 custom-bg-3 p-2 px-4 mt-4">
                        ...
                        <div class="card-body">
                            <div class="container-fluid p-0">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-md-end align-items-center justify-content-start">
                                        <a href="/lessons/{{$lesson->id}}" class="btn btn-warning  ml-md-4 mr-2 mr-md-0">Check me out</a>
                            ...
                            <!--description-->
                            <div class="card-text text-white-50">{!!substr($lesson->content,0,200)!!}... <a href="/lessons/{{$lesson->id}}">read more</a></div>
