...
@include('inc.messages')
  <div class="container my-5 py-2">
      <!--heading -->
      <h1 class="title font-weight-bold" style="color: #024089">{{$course->title}} - Activities</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-md-end align-items-center justify-content-start">
                                        @if (Auth::user()->courses->where('id',$course->id)->first()->pivot->role == 'teacher')
                                            <a href="{{route('activities.show',$activity->id)}}" class="btn btn-warning  ml-md-4 mr-2 mr-md-0">Manage</a>
                                        @else
