                        ...
                        <div id="hidden-box">
                          <form action="/api/answers/{{$section->id}}" method="post" id="answerForm">
                            <div class="form-group">
                              <label><span id="number">1.) </span> <span id="content">{{$section->questions->first()->content}}</span> </label>
                              
                            </div>

                            <div class="form-group ">
                                A.) <input type="radio" value="a" name="content"  id="option_a"><label class="pl-1" id="label_option_a">{{$section->questions->first()->option_a}}</label>
                                
                              </div>
                              <div class="form-group ">
                                B.) <input type="radio" value="b" name="content"  id="option_b"><label class="pl-1" id="label_option_b">{{$section->questions->first()->option_b}}</label>
                                
                              </div>
                              <div class="form-group ">
                                C.) <input type="radio" value="c" name="content" id="option_c"><label class="pl-1" id="label_option_c">{{$section->questions->first()->option_c}}</label>
                                
                              </div>
                              <div class="form-group ">
                                D.) <input type="radio" value="d" name="content"  id="option_d"><label class="pl-1" id="label_option_d">{{$section->questions->first()->option_d}}</label>
                           ...
                           answerForm.addEventListener('input',saveAnswer)
                            function saveAnswer(e) {
                              ...
                              xhr.onload = function() {
                                ...
                                document.getElementById('content').textContent = question.content + 'right';
